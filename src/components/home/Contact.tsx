      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        >
          <a
            ...
            className="flex items-center gap-3 px-8 py-4 rounded-xl glass-card hover:border-accent/60 transition-all group hover:-translate-y-1"
          >
            <FiLinkedin size={22} className="text-accent" />
            <div className="text-left">
              <span className="text-white font-semibold text-sm block">LinkedIn</span>
              <span className="text-text-secondary text-xs">Connect with me</span>
            </div>
            <FiArrowUpRight
              size={16}
              className="text-text-secondary group-hover:text-accent transition-colors ml-2"
            />
          </a>
        </motion.div>
      </div>
