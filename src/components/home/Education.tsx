  ...
  return (
    <section id="education" className="py-24 px-6 bg-[#0d0e14]" ref={ref}>
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-sm font-semibold uppercase tracking-widest text-accent-amber mb-3">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          >
            <div className="flex items-center gap-2 mb-6">
              <FiBookOpen className="text-accent-amber" size={18} />
              ...
              {education.map((ed, i) => (
                <div key={i} className="glass-card rounded-xl p-5">
                  <div className="flex items-start justify-between gap-2 mb-1">
                    ...
                    {ed.ongoing && (
                      <span className="text-[10px] font-bold uppercase tracking-wider text-accent-teal bg-accent-teal/10 px-2 py-0.5 rounded-full">
                        Ongoing
                      </span>
                    )}
                  </div>
                  <p className="text-text-secondary text-xs">{ed.institution}</p>
            ...
            <div className="space-y-4">
              {certifications.map((c, i) => (
                <div key={i} className="glass-card rounded-xl p-5">
                  ...
                  <p className="text-text-secondary text-xs">{c.issuer}</p>
                  {c.detail && (
          ...
          >
            <div className="flex items-center gap-2 mb-6">
              <FiAward className="text-accent-rose" size={18} />
            ...
            <div className="space-y-4">
              {awards.map((a, i) => (
                <div key={i} className="glass-card rounded-xl p-5">
                  ...
                  <p className="text-text-secondary text-xs">{a.category}</p>
